  ...
  <div class="row c-margin-t-40">
      <div class="col-xs-6">
          ...
          <div class="c-product-review-name">
              <h3 class="c-font-bold c-font-24 c-margin-b-5"><?php print $comment->name; ?></h3>
              <p class="c-date c-theme-font c-font-14"><?php print date('F', $comment->created) . date(' d, Y', $comment->created); ?></p>
          </div>
      </div>
      <div class="col-xs-6">
