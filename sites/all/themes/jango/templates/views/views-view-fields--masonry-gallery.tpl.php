...
$url = isset($image[0]) ? $image[0]['raw']['uri'] : '';
    ...
    <div class="cbp-caption-activeWrap">
      ...
      <div class="cbp-l-caption-alignCenter">
        <div class="cbp-l-caption-body">
          ...
          <a href="<?php print $path; ?>" class="cbp-lightbox cbp-l-caption-buttonRight btn c-btn-square c-btn-border-1x c-btn-white c-btn-bold c-btn-uppercase" data-title="<?php print $title; ?>"><?php print t('Zoom'); ?></a>
        </div>
      </div>
    </div>
  </div>
  <a href="<?php print url('node/' . $nid); ?>" class="cbp-singlePage cbp-l-grid-masonry-projects-title"><?php print _views_field($fields, 'title'); ?></a>
  <div class="cbp-l-grid-masonry-projects-desc"><?php print _views_field($fields, 'field_categories'); ?></div>
</div>