 ...
 */
 //dpm($fields);
_views_field($fields, 'field_text_color');
_views_field($fields, 'field_background_and_arrow_color_1');
_views_field($fields, 'field_background_and_arrow_color');
?>
<div class="col-md-6">
  <div class="c-content-tile-1">
    ...
    <?php if($fields['field_arrow']->content == 'right'): ?>
        ...
        <div class="c-tile-content c-bg-white c-content-v-center" data-height="height">
          <div class="c-wrapper">
            <div class="c-body c-center">
              <h3 class="c-tile-title c-font-25 c-line-height-34 c-font-uppercase c-font-bold"> <?php print _views_field($fields, 'title'); ?> </h3>
              <p class="c-tile-body"><?php print _views_field($fields, 'body'); ?></p>
      ...
      <div class="col-sm-6">
        <div class="c-tile-content c-bg-white c-arrow-<?php print _views_field($fields, 'field_arrow'); ?> c-content-overlay">
