...
$href = isset($image[0]) ? file_create_url($image[0]['raw']['uri']) : '';
    ...
    <div class="cbp-caption-activeWrap">
      <div class="cbp-l-caption-alignCenter">
        <div class="cbp-l-caption-body">
          <a href="<?php print url('node/' . $nid); ?>" class="cbp-singlePage cbp-l-caption-buttonLeft btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase"><?php print t('Explore'); ?></a>
          <a href="<?php print $href; ?>" class="cbp-lightbox cbp-l-caption-buttonRight btn btn-sm c-btn-square c-btn-border-1x c-btn-white  c-btn-uppercase" data-title="<?php print $title ?><br><?php print $descriptions; ?>"><?php print t('Zoom'); ?></a>
        </div>
      </div>
    </div>
  </div>
