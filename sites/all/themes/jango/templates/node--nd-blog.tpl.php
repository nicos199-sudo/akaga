...
$comments_count = is_array($comments_count) ? count($comments_count) : 0;
    ...
    <?php if ($teaser): ?>
      <div class="c-content-blog-post-1">
          ...
          <div class="c-panel">
              ...
              <div class="c-date"><?php print t('on'); ?>
                  <span
                      class="c-font-uppercase"><?php print date('d M Y', $created); ?> <?php print date('g:i A', $created); ?></span>
              </div>
