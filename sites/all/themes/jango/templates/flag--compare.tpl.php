...
<span class="<?php print $flag_wrapper_classes; ?>">
  ...
  <?php if($latest_view_mode == 'teaser_list') : ?>
    ...
    <?php if ($link_href): ?>
      <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> btn btn-sm btn-default c-btn-square c-btn-uppercase c-btn-bold" rel="nofollow"><i class="fa fa-exchange"></i><?php print $link_text; ?></a><span class="flag-throbber">&nbsp;</span>
    <?php else: ?>
      <span class="<?php print $flag_classes ?> btn btn-sm btn-default c-btn-square c-btn-uppercase c-btn-bold"><i class="fa fa-exchange"></i><?php print $link_text; ?></span>
    <?php endif; ?>

  <?php elseif($flag_short_display) : ?>

    <?php if ($link_href): ?>
      <a href="<?php print $link_href; ?>" class="btn btn-default c-btn c-btn-square c-theme-btn c-btn-border-1x c-btn-md <?php print $flag_classes; ?>" title="<?php print t('Compare'); ?>"></a>
    <?php else: ?>
      <a href="#" class="btn btn-default c-btn c-btn-square c-theme-btn c-btn-border-1x c-btn-md <?php print $flag_classes; ?>" title="<?php print t('Compare'); ?>"></a>
    <?php endif; ?>

  <?php else: ?>

    <?php if ($link_href): ?>
      <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="<?php print $flag_classes ?> btn btn-default c-btn c-btn-square c-theme-btn c-btn-border-1x c-btn-md" rel="nofollow"><?php print $link_text; ?></a><span class="flag-throbber">&nbsp;</span>
    <?php else: ?>
